            ...
            switch(msg.Type)
            {
                ...
                case MessageTypes.MethodCall:
                    ...
                    if (hub != null)
                        ...
                        HTTPManager.Logger.Warning("SignalR Connection", $"Hub \"{methodCall.Hub}\" not found!");
                ...
                case MessageTypes.Progress:
                    ...
                    if (hub != null)
                        ...
                        HTTPManager.Logger.Warning("SignalR Connection",
                            $"No Hub found for Progress message! Id: {id.ToString()}");
                    break;
            ...
            switch (req.State)
            {
                ...
                case HTTPRequestStates.Finished:
                    if (resp.IsSuccess)
                    {
                        ...
                        reason =
                            $"Ping - Request Finished Successfully, but the server sent an error. Status Code: {resp.StatusCode}-{resp.Message} Message: {resp.DataAsText}";
                    break;
